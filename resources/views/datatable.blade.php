...
<head>
	...
	<title>DataTables example - PDF - open in new window</title>
	...
	<script type="text/javascript" src="/media/js/dynamic.php?comments-page=extensions%2Fbuttons%2Fexamples%2Fhtml5%2FpdfOpen.html" async>
	</script>
...
<body class="wide comments example">
	...
	<div class="fw-container">
		...
		<div class="fw-body">
			<div class="content">
				<h1 class="page_title">PDF - open in new window</h1>
				<div class="info">
		...
		buttons: [
			{
				...
				download: 'open'
						...
						<ul>
							...
							<li>
								<a href=
								"https://cdn.datatables.net/buttons/1.3.1/js/dataTables.buttons.min.js">https://cdn.datatables.net/buttons/1.3.1/js/dataTables.buttons.min.js</a>
							</li>
							<li>
							...
							<li>
								<a href="//cdn.datatables.net/buttons/1.3.1/js/buttons.html5.min.js">//cdn.datatables.net/buttons/1.3.1/js/buttons.html5.min.js</a>
							</li>
						</ul>
					</div>
					<div class="table">
					...
					<div class="css">
						...
						<ul>
							...
							<li>
								<a href=
								"https://cdn.datatables.net/buttons/1.3.1/css/buttons.dataTables.min.css">https://cdn.datatables.net/buttons/1.3.1/css/buttons.dataTables.min.css</a>
							</li>
						</ul>
					</div>
					<div class="ajax">
